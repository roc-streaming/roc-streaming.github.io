...
roc_toolkit:
	...
	git clone git@github.com:roc-streaming/roc-toolkit.git build/roc-toolkit
...
rocd:
	...
	git clone git@github.com:roc-streaming/rocd.git build/rocd
...
roc_droid:
	...
	git clone -b flutter git@github.com:roc-streaming/roc-droid.git build/roc-droid
